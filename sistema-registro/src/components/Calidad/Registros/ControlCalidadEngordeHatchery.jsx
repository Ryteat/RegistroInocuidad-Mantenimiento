...
//import "./ControlCalidadEngordeHatchery.css";
...
function ControlCalidadEngordeHatchery() {
  let emptyRegister = {
    fecha_siembra: "",
    tipo_dieta: "",
    codigo: "",
  ...
  return (
    <div className="control-calidad-container">
      ...
      <h1>
        ...
        Control de Calidad Engorde Hatchery
      </h1>
...
export default ControlCalidadEngordeHatchery;