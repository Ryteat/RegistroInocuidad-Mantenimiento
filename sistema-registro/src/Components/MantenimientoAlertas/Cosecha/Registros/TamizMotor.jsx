// src/Components/MantenimientoAlertas/Cosecha/Registros/TamizMotor.jsx
...
const Q_TRIMESTRAL = [
    ...
    },
    {
        key: "q7",
        label:
            "Tomar lectura de amperaje y comparar con los datos de placa, Reporte",
    },
    ...
    },
    {
        key: "q10",
        label:
            "Verificar que el colector del motor y bobina se encuentren en su lugar, Reporte",
    },
];
...
export default function TamizMotor() {
        ...
        <div className="flex flex-wrap gap-2 align-items-center justify-content-between">
            <span className="p-input-icon-left">
                ...
                <InputText
                    ...
                    placeholder="Buscar (ej. COS-T-M, técnico, notas)"
                />
            </span>
    ...
    const exportXlsx = () => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, "TamizMotor");
        XLSX.writeFile(
            wb,
            `Cosecha_Tamiz_Motor_${new Date()
                .toISOString()
                .slice(0, 10)}.xlsx`
        );
    };
