// src/Components/MantenimientoAlertas/Cosecha/Registros/PanelControlGeneral.jsx
...
export default function PanelControlGeneral() {
    ...
    const exportXlsx = () => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, "Panel Control");
        XLSX.writeFile(
            wb,
            `Cosecha_PanelControl_${new Date()
                .toISOString()
                .slice(0, 10)}.xlsx`
        );
    };
    ...
    return (
        <div className="controlrendcosechayfrass-container">
            ...
            <h1 className="flex align-items-center gap-2">
                ...
                Registro — Panel de Control (General)
            </h1>
            ...
            <Dialog
                ...
                header="Nuevo registro — Panel de Control (General)"
                modal
                onHide={hideDialog}
                footer={
