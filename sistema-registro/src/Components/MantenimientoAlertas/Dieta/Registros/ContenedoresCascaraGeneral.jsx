// src/Components/MantenimientoAlertas/Dieta/Registros/ContenedoresCascaraGeneral.jsx
...
export default function ContenedoresCascaraGeneral() {
    ...
    return (
        <div className="controlrendcosechayfrass-container">
            ...
            <h1 className="flex align-items-center gap-2">
                ...
                Registro — Contenedores de Cáscara (General)
            </h1>
