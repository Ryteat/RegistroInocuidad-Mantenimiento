...
export default function MezcladoraGeneral() {
    ...
    const getActiveQuestions = () => {
        if (form.periodicidad === "SEMANAL") return Q_SEMANAL;
        if (form.periodicidad === "TRIMESTRAL") return Q_TRIMESTRAL;
        if (form.periodicidad === "ANUAL") return Q_ANUAL;
        return [];
    };
        ...
        <div className="flex flex-wrap gap-2 align-items-center justify-content-between">
            <span className="p-input-icon-left">
                ...
                <InputText
                    ...
                    placeholder="Buscar (ej. D-M-G, técnico, notas)"
                />
            </span>
    ...
    return (
        <div className="controlrendcosechayfrass-container">
            ...
            <Dialog
                ...
                header="Nuevo registro — Mezcladora (General)"
                modal
                onHide={hideDialog}
                footer={
