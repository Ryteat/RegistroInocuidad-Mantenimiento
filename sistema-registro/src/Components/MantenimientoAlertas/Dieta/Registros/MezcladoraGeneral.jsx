// src/Components/MantenimientoAlertas/Dieta/Registros/MezcladoraGeneral.jsx
...
/* ===== Constantes ===== */
const POSICION_ID_BASE = "D-M-G";
const EQUIPO = "MEZCLADORA";
const REGISTRO = "GENERAL";
const TABLE = "mto_dieta_mezcladora_general";
...
const Q_SEMANAL = [
    ...
    // TRANSMISIÓN
    { key: "q5", label: "Revisar estado y tensión de la cadena" },
    { key: "q6", label: "Verificar alineamiento" },
    { key: "q7", label: "Lubricar" },
    // ESTRUCTURA
    {
        key: "q8",
        label:
    ...
    // EJES
    { key: "q9", label: "Verificar el estado de los ejes, reporte." },
];
...
export default function MezcladoraGeneral() {
        ...
        try {
            ...
            if (editingId) {
                ...
                if (form.ejecutado === "SI" && todasSi) {
                    // COMPLETADO (queda en verde hasta que se cree nuevo registro mismo consecutivo)
                    updatePayload = {
                        ...updatePayload,
                    ...
                    // Ejecutado = "SI" pero con alguna NO → reprogramar según periodicidad
                    let proximo;
        ...
        <div className="flex flex-wrap gap-2 align-items-center justify-content-between">
            <span className="p-input-icon-left">
                ...
                <InputText
                    ...
                    placeholder="Buscar (ej. D-M-G-01, técnico, notas)"
                />
            </span>
    ...
    const exportXlsx = () => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, "Mezcladora");
        XLSX.writeFile(
            wb,
            `Dieta_MezcladoraGeneral_${new Date()
                .toISOString()
                .slice(0, 10)}.xlsx`
        );
    };
    ...
    return (
        <div className="controlrendcosechayfrass-container">
            ...
            <Dialog
                ...
                header={
                    editingId
                        ? "Editar registro — Mezcladora (General)"
                        : "Nuevo registro — Mezcladora (General)"
                }
                modal
                onHide={hideDialog}
                footer={
