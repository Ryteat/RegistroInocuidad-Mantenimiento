// src/Components/MantenimientoAlertas/Dieta/Registros/BandasLubricacion.jsx
...
/* ===== Helpers fecha (mismo patrón de otros registros) ===== */
const parseYMD = (s) => {
    if (!s) return null;
...
const POSICION_ID_BASE = "D-B-L";
const EQUIPO = "BANDAS";
const REGISTRO = "LUBRICACIÓN";
const TABLE = "mto_dieta_bandas_lubricacion";
...
/* ===== Preguntas SEMANAL (texto tomado de la OM) ===== */
const Q_SEMANAL = [
    // MUÑONERAS
    ...
    {
        key: "q5",
        label: "Revisar estado y nivel del aceite del reductor.",
    },
...
export default function BandasLubricacion() {
    ...
    const validate = () => {
        ...
        if (!form.cantidad) errs.push("Seleccione el consecutivo (01 o 02).");
        ...
        try {
            ...
            if (editingId) {
                ...
                if (form.ejecutado === "SI" && todasSi) {
                    // COMPLETADO → queda en verde hasta que se genere un nuevo registro
                    updatePayload = {
                        ...updatePayload,
                    ...
                    // Ejecutado = "SI" pero con alguna "NO" → reprogramar a +7 días
                    updatePayload = {
                        ...updatePayload,
                        ultimo_mantenimiento: baseDate,
                        proximo_mantenimiento: addDays(baseDate, 7),
                ...
                if (form.ejecutado === "NO") {
                    ...
                    ultimo = baseDate;
                    proximo = addDays(baseDate, 7); // SEMANAL
                }
        ...
        <div className="flex flex-wrap gap-2 align-items-center justify-content-between">
            <span className="p-input-icon-left">
                ...
                <InputText
                    ...
                    placeholder="Buscar (ej. D-B-L-01, técnico, notas)"
                />
            </span>
    ...
    const exportXlsx = () => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, "Bandas_Lubricacion");
        XLSX.writeFile(
            wb,
            `Dieta_Bandas_Lubricacion_${new Date()
                .toISOString()
                .slice(0, 10)}.xlsx`
        );
    };
    ...
    return (
        <div className="controlrendcosechayfrass-container">
            ...
            <h1 className="flex align-items-center gap-2">
                ...
                Registro — Lubricación de Bandas (Dieta)
            </h1>
            ...
            <Dialog
                ...
                header={
                    editingId
                        ? "Editar registro — Lubricación de Bandas (Dieta)"
                        : "Nuevo registro — Lubricación de Bandas (Dieta)"
                }
                modal
                onHide={hideDialog}
                footer={
