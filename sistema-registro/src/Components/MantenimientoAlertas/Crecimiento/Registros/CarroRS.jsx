// src/Components/MantenimientoAlertas/Crecimiento/Registros/CarroRS.jsx
...
// Opciones O / I / RD / RP para cada ítem
...
const Q_BISEMANAL = [
    { key: "q1", label: "Comprobar estructura del carro" },
    { key: "q2", label: "Comprobar estado ruedas carro" },
    {
        key: "q3",
        label:
            "Revisión rodamientos levas elevación (presencia de polvo, desgaste)",
    },
    {
        key: "q4",
        label: "Limpieza y/o engrase y tensión cadenas de transmisión",
    },
    {
        key: "q5",
        label: "Verificar estado y funcionamiento de frenos en los motores",
    },
    { key: "q6", label: "Revisar rodamientos de apoyo en elevación" },
    { key: "q7", label: "Revisar holguras de elevación. Guías" },
    {
        key: "q8",
        label:
            "Comprobar estado y desgaste de escobillas de carga baterías/condensadores",
    },
    {
        key: "q9",
        label:
            "Comprobar posicionamiento elevación (finales de carrera y testigo)",
    },
    { key: "q10", label: "Comprobar posicionamiento en AS" },
    { key: "q11", label: "Aspirado interior del cajón. Limpieza" },
    {
        key: "q12",
        label: "Comprobar y limpiar controles de presencia y gálibos",
    },
    { key: "q13", label: "Estado y fijación del encoder" },
    { key: "q14", label: "Reapriete de terminales" },
];
...
export default function CarroRS() {
    ...
    const onAccionChange = (key, value) =>
        setForm((p) => ({
            ...p,
    ...
    const exportXlsx = () => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, "Carro RS");
        XLSX.writeFile(
            wb,
            `Crecimiento_Carro_RS_${new Date()
                .toISOString()
                .slice(0, 10)}.xlsx`
        );
    };
