...
const POSICION_ID_BASE = "H-SBC-G"; // base, se completa con -01 / -02
const EQUIPO = "SELLADORA DE BANDA CONTINUA";
...
/* Este registro tiene 2 selladoras (01..02) */
const CANTIDAD_OPTIONS = [
    { label: "01", value: 1 },
    { label: "02", value: 2 },
];

/* ===== Preguntas EXACTAS (OM) ===== */
const Q_SEMESTRAL = [
    {
        key: "q1",
        label:
            "Verifique el estado de desgaste de la escobilla de carbón del motor. Reporte",
    },
    {
        key: "q2",
        label:
            "Adicionar grasa lubricante a los engranajes que están expuestos sin tapa",
    },
];
...
const Q_MENSUAL = [
    {
        key: "q1",
        label: "Compruebe si la correa de sellado está desgastada o no",
    },
    {
        key: "q2",
        label: "Compruebe si la correa guía de sellado está desgastada o no",
    },
...
const Q_ANUAL = [
    { key: "q1", label: "Verifique exhaustivamente la máquina" },
    {
        key: "q2",
        label:
            "Compruebe si la rueda de goma está deteriorada, reemplace si es necesario",
    },
    {
        key: "q3",
        label:
            "Verifique que el controlador de temperatura alcance el valor seteado en 10 minutos, de lo contrario cambie el controlador.",
    },
    {
        key: "q4",
        label:
            "Compruebe si las piezas electrónicas, paro de emergencia, potenciómetro, ventilador, botones funcionan correctamente.",
    },
    {
        key: "q5",
        label:
            "Revise y engrase las partes de transmisión, engranajes, ejes y juntas. Cambie si es necesario. Limpie la caja de engranajes y cambie el aceite",
    },
];

const getQuestionsFor = (periodicidad) => {
    if (periodicidad === "SEMESTRAL") return Q_SEMESTRAL;
...
export default function SelladoraBandaContinuaGeneral() {
    ...
    const validate = () => {
        ...
        if (!form.cantidad) errs.push("Seleccione la cantidad (01 o 02).");
        ...
        try {
            ...
            if (editingId) {
                ...
                if (form.ejecutado === "SI" && todasSi) {
                    ...
                    // se reprograma según periodicidad (sigue venciendo hasta que esté todo SI)
                    let proximo = addDays(baseDate, 7);
                    if (form.periodicidad === "SEMESTRAL") {
        ...
        <div className="flex flex-wrap gap-2 align-items-center justify-content-between">
            <span className="p-input-icon-left">
                ...
                <InputText
                    ...
                    placeholder="Buscar (H-SBC-G-01, técnico, notas)"
                />
            </span>
    ...
    const exportXlsx = () => {
        ...
        XLSX.writeFile(
            wb,
            `Horno_SelladoraBandaContinua_General_${new Date()
                .toISOString()
                .slice(0, 10)}.xlsx`
        );
    };
    ...
    return (
        <div className="controlrendcosechayfrass-container">
            ...
            <Dialog
                ...
                header={
                    editingId
                        ? "Editar registro — Selladora de Banda Continua (General)"
                        : "Nuevo registro — Selladora de Banda Continua (General)"
                }
                modal
                onHide={hideDialog}
                footer={
                ...
                <div className="p-fluid grid">
                    <div className="field col-12 md:col-4">
                        ...
                        <small className="block mt-2">
                            <b>Mensual</b>: +1 mes; <b>Semestral</b>: +6 meses;{" "}
                            <b>Anual</b>: +12 meses. Si NO ejecutado: siempre{" "}
                            <b>+7 días</b>.
                        </small>
                    </div>
