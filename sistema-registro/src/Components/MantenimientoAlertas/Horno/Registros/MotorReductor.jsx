...
const POSICION_ID_BASE = "H-EL-MR";
        ...
        <div className="flex flex-wrap gap-2 align-items-center justify-content-between">
            <span className="p-input-icon-left">
                ...
                <InputText
                    ...
                    placeholder="Buscar (ej. H-EL-MR-01, técnico, notas)"
                />
            </span>
    ...
    return (
        <div className="controlrendcosechayfrass-container">
            ...
            <Dialog
                ...
                header={
                    editingId
                        ? "Editar registro — Motor Reductor (Empacadora de Larva)"
                        : "Nuevo registro — Motor Reductor (Empacadora de Larva)"
                }
                modal
                onHide={hideDialog}
                footer={
            ...
            <Dialog
                ...
                header="Detalle del registro — Motor Reductor (Empacadora de Larva)"
                modal
