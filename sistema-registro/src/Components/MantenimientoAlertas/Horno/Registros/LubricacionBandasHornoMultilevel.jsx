...
/* ===== Helpers de fecha (patrón general) ===== */
const parseYMD = (s) => {
    if (!s) return null;
...
/* ===== Constantes del registro (H-HM-LB) ===== */
const POSICION_ID_BASE = "H-HM-LB";
...
const Q_SEMANAL = [
    ...
    { key: "q6", label: "Verificar que no existan fugas" },
    {
        key: "q7",
        label:
            "Revisar estado de estructura, presencia de reventaduras y sus anclajes",
    },
    {
        key: "q8",
        label:
...
const emptyForm = () => ({
    ...
    equipo: EQUIPO,
    registro: REGISTRO,
    cantidad: null, // se escoge en el dropdown (solo 01)
    tecnico: "",
    ejecutado: "",
    observaciones: "",
    periodicidad: "",
...
export default function LubricacionBandasHornoMultilevel() {
        ...
        try {
            ...
            if (editingId) {
                ...
                if (form.ejecutado === "SI" && todasSi) {
                    // COMPLETADO: se queda en verde hasta que se cree un registro nuevo con mismo consecutivo
                    updatePayload = {
                        ...updatePayload,
                    ...
                    // Ejecutado = "SI" pero con alguna NO → sigue SEMANAL (+7d)
                    updatePayload = {
                        ...updatePayload,
                        ultimo_mantenimiento: baseDate,
                        proximo_mantenimiento: addDays(baseDate, 7),
    ...
    const revisadoTemplate = (row) => {
        const { canReview: canR, username: user } = {
            canReview,
            username,
        };
        ...
        <div className="flex flex-wrap gap-2 align-items-center justify-content-between">
            <span className="p-input-icon-left">
                ...
                <InputText
                    ...
                    placeholder="Buscar (ej. H-HM-LB-01, técnico, notas)"
                />
            </span>
    ...
    const exportXlsx = () => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, "HornoML_LubricacionBandas");
        XLSX.writeFile(
            wb,
            `Horno_Multilevel_LubricacionBandas_${new Date()
                .toISOString()
                .slice(0, 10)}.xlsx`
        );
    };
    ...
    return (
        <div className="controlrendcosechayfrass-container">
            ...
            <Dialog
                ...
                header={
                    editingId
                        ? "Editar registro — Lubricación de Bandas (Horno Multilevel)"
                        : "Nuevo registro — Lubricación de Bandas (Horno Multilevel)"
                }
                modal
                onHide={hideDialog}
                footer={
