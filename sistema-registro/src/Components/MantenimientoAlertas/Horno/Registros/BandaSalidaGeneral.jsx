...
/* Cantidad fija 2 → consecutivo 01 / 02 */
const CANTIDAD_OPTIONS = [
    { label: "01", value: 1 },
    { label: "02", value: 2 },
];

/* Preguntas por periodicidad */
// Semanal
const Q_SEMANAL = [
...
export default function BandaSalidaGeneral() {
    ...
    const validate = () => {
        ...
        if (!form.cantidad) errs.push("Seleccione la cantidad (01 / 02).");
        ...
        <div className="flex flex-wrap gap-2 align-items-center justify-content-between">
            <span className="p-input-icon-left">
                ...
                <InputText
                    ...
                    placeholder="Buscar (H-BS-G-01/02, técnico, notas)"
                />
            </span>
    ...
    const exportXlsx = () => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, "BandaSalida");
        XLSX.writeFile(
            wb,
            `Horno_BandaSalidaGeneral_${new Date()
                .toISOString()
                .slice(0, 10)}.xlsx`
        );
    };
    ...
    return (
        <div className="controlrendcosechayfrass-container">
            ...
            <Dialog
                ...
                header={
                    editingId
                        ? "Editar registro — Banda de Salida (General)"
                        : "Nuevo registro — Banda de Salida (General)"
                }
                modal
                onHide={hideDialog}
                footer={
