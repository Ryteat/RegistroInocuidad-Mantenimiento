// src/Components/MantenimientoAlertas/Horno/Registros/BandaSalidaGeneral.jsx
...
/* ===== Constantes ===== */
const POSICION_ID = "H-BS-G";
const EQUIPO = "BANDA DE SALIDA";
const REGISTRO = "GENERAL";
const TABLE = "mto_horno_banda_salida_general";
...
/* Preguntas EXACTAS por periodicidad (de tus hojas) */
// Semanal
const Q_SEMANAL = [
...
// Trimestral (igual al checklist de Motor Reductor trimestral)
const Q_TRIMESTRAL = [
    ...
    { key: "q9", label: "Revisar que no hallan presencia de vibraciones o ruidos extraños" },
...
// Anual (igual al checklist de Motor Reductor anual)
const Q_ANUAL = [
...
export default function BandaSalidaGeneral() {
    ...
    const header = (
        <div className="flex flex-wrap gap-2 align-items-center justify-content-between">
            <span className="p-input-icon-left">
                ...
                <InputText type="search" value={globalFilter} onInput={(e) => setGlobalFilter(e.target.value)} placeholder="Buscar (ej. H-BS-G, técnico, notas)" />
            </span>
    ...
    const exportXlsx = () => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, "BandaSalida-Gen");
        XLSX.writeFile(wb, `Horno_BandaSalida_General_${new Date().toISOString().slice(0, 10)}.xlsx`);
    };
    ...
    return (
        <div className="controlrendcosechayfrass-container">
            ...
            <h1 className="flex align-items-center gap-2">
                ...
                Registro — Banda de Salida (General)
            </h1>
            ...
            <Dialog visible={dialogOpen} style={{ width: "72vw", maxWidth: 1100 }}
                header="Nuevo registro — Banda de Salida (General)" modal onHide={hideDialog}
                ...
                <div className="p-fluid grid">
                    <div className="field col-12 md:col-4">
                        ...
                        <small className="block mt-2">
                            <b>Semanal</b>: +7 días; <b>Trimestral</b>: +3 meses; <b>Anual</b>: +12 meses.
                        </small>
                    </div>
