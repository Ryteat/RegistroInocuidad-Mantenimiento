...
const POSICION_ID_BASE = "H-HM-LG"; // base, se completa con -01
...
// Sólo MENSUAL, pero usamos mismo patrón de dropdown
const PERIODOS = [{ label: "Mensual", value: "MENSUAL" }];

/* Este registro tiene cantidad fija 1 → consecutivo 01 */
const CANTIDAD_OPTIONS = [{ label: "01", value: 1 }];

/* ===== Preguntas MENSUALES (15) ===== */
const Q_MENSUAL = [
...
export default function LineaGasGLPHornoMultilevel() {
        ...
        <div className="flex flex-wrap gap-2 align-items-center justify-content-between">
            <span className="p-input-icon-left">
                ...
                <InputText
                    ...
                    placeholder="Buscar (H-HM-LG-01, técnico, notas)"
                />
            </span>
    ...
    const exportXlsx = () => {
        ...
        XLSX.writeFile(
            wb,
            `Horno_LineaGasGLP_${new Date().toISOString().slice(0, 10)}.xlsx`
        );
    };
    ...
    return (
        <div className="controlrendcosechayfrass-container">
            ...
            <Dialog
                ...
                header={
                    editingId
                        ? "Editar registro — Línea de Gas GLP (Horno Multilevel)"
                        : "Nuevo registro — Línea de Gas GLP (Horno Multilevel)"
                }
                modal
                onHide={hideDialog}
                footer={
            ...
            >
                <div className="p-fluid grid">
                    {/* Periodicidad (solo MENSUAL, pero mismo patrón visual) */}
                    <div className="field col-12 md:col-4">
                        ...
                        <small className="block mt-2">
                            <b>Mensual</b>: +1 mes. Si NO ejecutado: siempre{" "}
                            <b>+7 días</b>.
                        </small>
                    </div>
